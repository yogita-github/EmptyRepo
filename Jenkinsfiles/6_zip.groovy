pipeline {
    ...
    environment {
        ...
        CLONE_DIR = 'C:\\Jenkins\\workspace\\EmptyRepo'  // Local path where the repo will be cloned in Jenkins workspace
        ZIP_PATH = 'C:\\Jenkins\\workspace\\output\\build_output.zip'  // Path where the zip will be saved
    }
